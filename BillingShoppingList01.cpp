 ...
 * New Update : On the previous program, when the items list were on display, it didn't show the total value long with it. In fact we had to enter case 2 to call displaySum(). But in this program, case 2 is removed and there is only case 1 to 3. Now when the items list is displayed, the total value also displayed along with it
 */
...
public://It is a public access specifier
    ...
    void getitem(void){//It is a "getitem" function whose return type is void
        ...
        displaySum();//It calls the "displaySum" function to display the items input by the user
    }
...
int main(){
    ...
    do{
        ...
        cout << "\n2 : Delete an item.";//It displays all the text within the " " on the console
        cout << "\n3 : Quit.";//It displays all the text within the " " on the console
        cout << "\n-------------------------------------" <<endl;//It displays all the text within the " " on the console
        cout <<"> Choose from (1 to 3) only."<<endl<<"> Enter an appropriate number : ";//It displays all the text within the " " on the console
        ...
        switch(input){
            ...
            case 2 : order.remove();//It executes the "remove" function
                break;//It breaks the case after the execution
            case 3 : break;//it breaks the case after the execution
    ...
    }while(input != 3);//It is a do-while loop condition, it is a condition set for the loop not exit. It means that this loop will run until the input is 4
